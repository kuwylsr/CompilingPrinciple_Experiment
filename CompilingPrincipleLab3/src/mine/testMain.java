...
//				System.out.println(dirPath+"..."+fileName);
	...
	public void Wenfa_init(ArrayList<str_value> w,HashMap<String,F_enter> fu_table,DefaultTableModel err) throws IOException{//语法初始化兼运行
	...
	public void LR1_main(ArrayList<ArrayList<String>> table,ArrayList<str_value> w,HashMap<Integer,String> hash_flag, String [][]WEN_INIT,HashMap<String,F_enter> futable) throws IOException{//LR1分析算法
