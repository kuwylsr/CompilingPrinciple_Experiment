...
import Lexical_Analysis.symbolTable2.delimiter;
import Lexical_Analysis.symbolTable2.keyWord;
import Lexical_Analysis.symbolTable2.operator;
	...
	public Map<String,String> analysis(String content) {
		...
		for(int i = 0;i<content.length();i++) {
				...
				//判定是否为常数
					...
					tokens.append(formLine(sTemp.toString(), "digit", sTemp.toString()));
					sTemp.delete(0, sTemp.length());
				}
				//判定是否为运算符
